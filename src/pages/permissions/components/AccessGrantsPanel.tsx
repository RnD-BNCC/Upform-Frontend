...
import { BaseModal, Toggle, UserSearchSelect } from "@/components/ui";
        ...
        <div className="space-y-4 px-5 py-4">
          ...
          <label className="block text-xs font-semibold text-gray-500">
            ...
            <textarea
              ...
              rows={3}
              className="mt-1 w-full resize-y rounded-md border border-gray-200 px-3 py-2 text-sm text-gray-800 outline-none focus:border-primary-400"
            />
          </label>
