                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                  <div className="flex justify-between items-center mb-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Hybrid Event Distribution</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-xs font-bold text-blue-600">
                        ...
                        <span>{responses.length}/{capacity.onlineLimit}</span>
                      </div>
                      <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(
                              (responses.length / capacity.onlineLimit) * 100,
                              100
                            )}%`,
                          }}
                        />
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-xs font-bold text-orange-600">
                        ...
                        <span>{responses.length}/{capacity.offlineLimit}</span>
                      </div>
                      <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(
                              (responses.length / capacity.offlineLimit) * 100,
                              100
                            )}%`,
                          }}
                        />
